...
<!--
  ...
  QCR Modifications [14/11/21]:
    - Updated mesh filempaths to enable usage with roboticstoolbox
-->
  ...
  <xacro:macro name="xarm6_urdf" params="prefix
    ...
    <link name="${prefix}link_base">
      <visual>
        <geometry>
          <mesh filename="package://armer_xarm/data/xacro/meshes/xarm6/visual/base.stl"/>
        </geometry>
    ...
    <link name="${prefix}link1">
      <visual>
        <geometry>
          <mesh filename="package://armer_xarm/data/xacro/meshes/xarm6/visual/link1.stl"/>
        </geometry>
        <origin xyz="0 0 0" rpy="0 0 0"/>
        <material name="${prefix}White" />
      </visual>
    ...
    <link name="${prefix}link2">
      <visual>
        <geometry>
          <mesh filename="package://armer_xarm/data/xacro/meshes/xarm6/visual/link2.stl"/>
        </geometry>
        <origin xyz="0 0 0" rpy="0 0 0"/>
        <material name="${prefix}White" />
      </visual>
    ...
    <link name="${prefix}link3">
      <visual>
        <geometry>
          <mesh filename="package://armer_xarm/data/xacro/meshes/xarm6/visual/link3.stl"/>
        </geometry>
        <origin xyz="0 0 0" rpy="0 0 0"/>
        <material name="${prefix}White" />
      </visual>
    ...
    <link name="${prefix}link4">
      <visual>
        <geometry>
          <mesh filename="package://armer_xarm/data/xacro/meshes/xarm6/visual/link4.stl"/>
        </geometry>
        <origin xyz="0 0 0" rpy="0 0 0"/>
        <material name="${prefix}White" />
      </visual>
    ...
    <link name="${prefix}link5">
      <visual>
        <geometry>
          <mesh filename="package://armer_xarm/data/xacro/meshes/xarm6/visual/link5.stl"/>
        </geometry>
        <origin xyz="0 0 0" rpy="0 0 0"/>
        <material name="${prefix}White" />
      </visual>
    ...
    <link name="${prefix}link6">
      <visual>
        <geometry>
          <mesh filename="package://armer_xarm/data/xacro/meshes/xarm6/visual/link6.stl"/>
        </geometry>
        <origin xyz="0 0 0" rpy="0 0 0"/>
        <material name="${prefix}Silver" />
      </visual>
      <collision>
        <geometry>
          <mesh filename="package://armer_xarm/data/xacro/meshes/end_tool.STL"/>
        </geometry>
        <origin xyz="0 0 0" rpy="0 0 0"/>
      </collision>
      <inertial>
